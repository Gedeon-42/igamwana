...
<div class="student-form-wrapper">
    ...
    <form action="/admin/students" enctype="multipart/form-data" method="post">
        @csrf
...
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" placeholder="guardian name" class="@error('Parent') border-error @enderror" name="Parent" value={{old('Parent')}}>
    </div>
</div>
<div class="student-information-desc">
