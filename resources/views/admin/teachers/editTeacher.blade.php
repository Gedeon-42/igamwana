...
<div class="student-form-wrapper">
    ...
    <form action="/admin/teacher/{{$teacher['id']}}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PUT')
...
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" placeholder="full name" class="@error('Fullname') error_border @enderror" name="Fullname" value={{ $teacher['Fullname']}}>
    </div>
...
<div class="student-information-desc">
    ...
    @enderror
    <input type="email" class="@error('email') error_border @enderror" name="email" value="{{$teacher['email']}}" placeholder=" contact email"><br>
    </div>
...
<select name="province" value={{$teacher['province']}} id="province">
...
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" class="@error('district') border-error @enderror" placeholder="district" name="district" value={{$teacher['district']}} >
    </div>
...
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" class="@error('sector') border-error @enderror" placeholder="sector" name="sector" value={{$teacher['sector']}} >
    </div>
</div>
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" placeholder="cell" class="@error('cell') border-error @enderror" name="cell" value={{$teacher['cell']}}>
    </div>
</div>
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" placeholder="village" class="@error('village') border-error @enderror" name="village" value={{$teacher['village']}}>
    </div>
</div>
<div class="student-information-desc">
    ...
    @enderror
        <input type="date" class="@error('DOB') border-error @enderror" name="DOB" value={{$teacher['DOB']}}>
    </div>
</div>
<div class="student-information-desc">
    ...
    @enderror
        <input type="text" placeholder="Course teach" class="@error('courseteach') border-error @enderror" name="courseteach" value={{$teacher['courseteach']}}>
    </div>
</div>
<div class="student-information-desc">
    <label for="degree">Highest degree <span>*</span></label>
    <div>
        <select name="degree" id="degree" value="{{$teacher['degree']}}}" >
...
@enderror
    <input type="text" placeholder="Phone number" class="@error('Phone') border-error @enderror" name="Phone" value={{$teacher['Phone']}} >
</div>
</div>
    </div>
